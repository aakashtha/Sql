...
--return all the track names that have a song length longer than average song length.Return the 
...
---find how much amount spent by each customers on artits?Write a query to return customer name,
